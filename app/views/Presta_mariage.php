    ...
    <section  class="centre">
        ...
        <div id="essentiel" class="essentiel">
            <div class="description">
                ...
                <p>L'essentiel : une soirée animée avec un DJ professionnel et un maître de cérémonie pour une ambiance
                    garantie</p>
        ...
        <div id="privilege" class="privilege">
            <div class="description">
                <div class="left">
                    ...
                    <p>Un pack complet pour une immersion totale et une mise en scène soignée.
                    </p>
        ...
        <div id="royal" class="royal">
            ...
            <div class="description">
                    ...
                    <p>Le summum de l’élégance et du spectacle pour un mariage inoubliable, alliant musique live, mise en scène grandiose et effets spéciaux prestigieux.
                    </p>
                    <ul>
                        <h4>Ce pack comprend:</h4>
                        <li><i class="fa-solid fa-circle-check"></i><span> BACK LINE</span> avec l'orchestre de votre choix</li>
                        <li><i class="fa-solid fa-circle-check"></i> Pack<span> SONO PRO XXL</span> pour une qualité sonore incomparable</li>
                        <li><i class="fa-solid fa-circle-check"></i> Maître de cérémonie/Animateur(Atalaku) de votre choix</li>
                        <li><i class="fa-solid fa-circle-check"></i><span> DJ PRO</span> de votre choix</li>
                        <li><i class="fa-solid fa-circle-check"></i> Pack<span> LUMIÈRES PRO XXL</span> pour une scénographie immersive</li>
                        <li><i class="fa-solid fa-circle-check"></i><span> Nuage au sol </span>pour une entrée féérique</li>
                        <li><i class="fa-solid fa-circle-check"></i> Projecteur<span> LASER 3D </span>avec effet suivi précis garantie</li>
                        <li><i class="fa-solid fa-circle-check"></i> Grand<span> Écran Mur LED </span>pour des projections spéctaculaires</li>
                        <li><i class="fa-solid fa-circle-check"></i><span> PACK SONO ESSENTIEL </span>pour votre cérémonie nuptiale offert</li>
                        <li><i class="fa-solid fa-circle-check"></i><span> 4 fontaines de jet d'artifice inclus </span>pour sublimer votre ouverture de bal</li>
